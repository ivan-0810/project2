...
const DMWorkExpirience = (props) => {
 ...
 ////inputi///////
    ...
    return (
        <div className="DMWorkExpirience ">
            <div className = "onAdd">
            ...
            {niza.map( (el,key) => (
              <div key={key} id={el.id} className= "dm-work-expirience work-expirience ">
                ...
                {(!onFormHideInput || !editMode) && 
                    ...
                    <Fragment>
                        ...
                        {el.ul.length > -1 && el.ul.map((el,key) => (
                          ...
                          <li key={key} className="dm-li"><div className="krugche"></div>{el}</li>
