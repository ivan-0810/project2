...
import "./DataScienceWorkExpirience.css";
import Popup from '../../WebDevelopment/Popup';


const DataScienceWorkExpirience = (props) => {
 ...
 ////inputi///////
    ...
    // se submitira samo listata vo acomplishments
            ...
            <div className="add-edit-remove">
                ...
                {(!onFormHideInput || !editMode) &&               
                    <Fragment>
                        ...
                        <span className="span-right" >{el.span2}</span>
                        <h5 >{el.Accomplishments != "" ?el.Accomplishments : "Accomplishments"}</h5>
                        <ul>
                        {el.ul.length > -1 && el.ul.map((el,key) => (
                          
                          <li key={key}><i className="fas fa-minus"></i>{el}</li>
                     ...
                     'Achievements/Tasks' empty it will be automaticly filled with 'Accomplishments' "/>
                        ...
                        <div className="date-div-style">
                            ...
                            {!isChecked ?
                                ...
                                :
                                <span className="span-left"style={{ margin: "9px", borderBottom: "1px solid #354457", marginBottom: "1px" }} >present</span>
                            }
...
export default DataScienceWorkExpirience;